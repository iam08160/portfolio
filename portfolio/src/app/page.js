    ...
    <main className="bg-white px-10 md:px-20 lg:px-30 dark:bg-gray-900">
      <section className="h-screen">
        ...
        <div className="text-center p-10">
          ...
          <h3 className="text-2xl py-2 md:text-3xl dark:text-white">Developer and Sales Representative.</h3>
      ...
      <section>
        <div>
          <h3 className="text-3xl py-1 dark:text-white"> What I've Learned So Far</h3>
          <p className=" text-md py-2 leading-8 text-gray-800 dark:text-white" >
            ...
            languages such as <span className="text-teal-500">HTML</span>,
      ...
      <section>
        <div>
          <h3 className="text-3xl py-6 dark:text-white"> Projects I've Worked On</h3>
          ...
          <p className="text-md py-4 leading-8 text-gray-800 dark:text-white">
            ...
            real-world capstone project during the final 4 weeks of the course.
            Our class was tasked with creating a fully functioning full-stack
            web application called Cosmable. Cosmable is designed for
            beauticians and aesteticians in the Chicago metropolitain area to
            upload and showcase their work. My role in this project involved
          ...
          <div className=" flex justify-center gap-5 py-3">
            ...
            <div className=" mx-auto shadow-lg rounded-xl">
              ...
              <span className="text-teal-500">handleRedirect</span> function used after authentication is complete,
                authorization code exhanged for <span className="text-teal-500">access token</span>, <span className="text-teal-500">useEffect</span> hook
                used to redirect back to our application.
              </p>
            </div>
            <div className=" text-center shadow-lg rounded-xl">
              ...
              <span className="text-teal-50">Fetch</span> used to grab user's media using <span className="text-teal-500">access-token</span>,
              <span className="text-teal-500"> handleSelectedMedia</span> function used to select desired images and
